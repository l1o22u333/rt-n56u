...
{
	{ 1,   14, 31, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 31, BOTH, FALSE},	/*5170~5250MHz, Ch 36~48, Max BW: 40 */
	{ 52,   4, 31, BOTH, FALSE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */
	{ 100, 12, 31, BOTH, FALSE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
	{ 149,  5, 31, BOTH, FALSE},	/*5735~5835MHz, Ch 149~165, Max BW: 40 */
	{ 0},               	    	/* end*/
};
/*Algeria*/
...
CH_REGION ChRegion[] = {
	{"AL", CE, FALSE, Country_AL_ChDesp}, /* Albania */
	{"DZ", CE, FALSE, Country_DZ_ChDesp}, /* Algeria */
	{"AR", CE, FALSE, Country_AR_ChDesp}, /* Argentina */
	{"AM", CE, FALSE, Country_AM_ChDesp}, /* Armenia */
	{"AW", CE, FALSE, Country_AW_ChDesp}, /* Aruba */
	{"AU", CE, FALSE, Country_AU_ChDesp}, /* Australia */
	{"AT", CE, FALSE, Country_AT_ChDesp}, /* Austria */
	{"AZ", CE, FALSE, Country_AZ_ChDesp}, /* Azerbaijan */
	{"BH", CE, FALSE, Country_BH_ChDesp}, /* Bahrain */
	{"BD", CE, FALSE, Country_BD_ChDesp}, /* Bangladesh */
	{"BB", CE, FALSE, Country_BB_ChDesp}, /* Barbados */
	{"BY", CE, FALSE, Country_BY_ChDesp}, /* Belarus */
	{"BE", CE, FALSE, Country_BE_ChDesp}, /* Belgium */
	{"BZ", CE, FALSE, Country_BZ_ChDesp}, /* Belize */
	{"BO", CE, FALSE, Country_BO_ChDesp}, /* Bolivia */
	{"BA", CE, FALSE, Country_BA_ChDesp}, /* Bosnia and Herzegovina */
	{"BR", CE, FALSE, Country_BR_ChDesp}, /* Brazil */
	{"BN", CE, FALSE, Country_BN_ChDesp}, /* Brunei Darussalam */
	{"BG", CE, FALSE, Country_BG_ChDesp}, /* Bulgaria */
	{"KH", CE, FALSE, Country_KH_ChDesp}, /* Cambodia */
	{"CA", FCC, FALSE, Country_CA_ChDesp}, /* Canada */
	{"CL", CE, FALSE, Country_CL_ChDesp}, /* Chile */
	{"CN", CHN, FALSE, Country_CN_ChDesp}, /* China */
	{"CO", CE, FALSE, Country_CO_ChDesp}, /* Colombia */
	{"CR", CE, FALSE, Country_CR_ChDesp}, /* Costa Rica */
	{"HR", CE, FALSE, Country_HR_ChDesp}, /* Croatia */
	{"CY", CE, FALSE, Country_CY_ChDesp}, /* Cyprus */
	{"CZ", CE, FALSE, Country_CZ_ChDesp}, /* Czech Republic */
	{"DK", CE, FALSE, Country_DK_ChDesp}, /* Denmark */
	{"DO", CE, FALSE, Country_DO_ChDesp}, /* Dominican Republic */
	{"EC", CE, FALSE, Country_EC_ChDesp}, /* Ecuador */
	{"EG", CE, FALSE, Country_EG_ChDesp}, /* Egypt */
	{"SV", CE, FALSE, Country_SV_ChDesp}, /* El Salvador */
	{"EE", CE, FALSE, Country_EE_ChDesp}, /* Estonia */
	{"FI", CE, FALSE, Country_FI_ChDesp}, /* Finland */
	{"FR", CE, FALSE, Country_FR_ChDesp}, /* France */
	{"GE", CE, FALSE, Country_GE_ChDesp}, /* Georgia */
	{"DE", CE, FALSE, Country_DE_ChDesp}, /* Germany */
	{"GR", CE, FALSE, Country_GR_ChDesp}, /* Greece */
	{"GL", CE, FALSE, Country_GL_ChDesp}, /* Greenland */
	{"GD", CE, FALSE, Country_GD_ChDesp}, /* Grenada */
	{"GU", CE, FALSE, Country_GU_ChDesp}, /* Guam */
	{"GT", CE, FALSE, Country_GT_ChDesp}, /* Guatemala */
	{"HT", CE, FALSE, Country_HT_ChDesp}, /* Haiti */
	{"HN", CE, FALSE, Country_HN_ChDesp}, /* Honduras */
	{"HK", CE, FALSE, Country_HK_ChDesp}, /* Hong Kong */
	{"HU", CE, FALSE, Country_HU_ChDesp}, /* Hungary */
	{"IS", CE, FALSE, Country_IS_ChDesp}, /* Iceland */
	{"IN", CE, FALSE, Country_IN_ChDesp}, /* India */
	{"ID", CE, FALSE, Country_ID_ChDesp}, /* Indonesia */
	{"IR", CE, FALSE, Country_IR_ChDesp}, /* Iran, Islamic Republic of */
	{"IE", CE, FALSE, Country_IE_ChDesp}, /* Ireland */
	{"IL", CE, FALSE, Country_IL_ChDesp}, /* Israel */
	{"IT", CE, FALSE, Country_IT_ChDesp}, /* Italy */
	{"JM", CE, FALSE, Country_JM_ChDesp}, /* Jamaica */
	{"JP", JAP, FALSE, Country_JP_ChDesp}, /* Japan */
	{"JO", CE, FALSE, Country_JO_ChDesp}, /* Jordan */
	{"KZ", CE, FALSE, Country_KZ_ChDesp}, /* Kazakhstan */
	{"KE", CE, FALSE, Country_KE_ChDesp}, /* Kenya */
	{"KP", CE, FALSE, Country_KP_ChDesp}, /* Korea, Democratic People's Republic of */
	{"KR", CE, FALSE, Country_KR_ChDesp}, /* Korea, Republic of */
	{"KW", CE, FALSE, Country_KW_ChDesp}, /* Kuwait */
	{"LV", CE, FALSE, Country_LV_ChDesp}, /* Latvia */
	{"LB", CE, FALSE, Country_LB_ChDesp}, /* Lebanon */
	{"LI", CE, FALSE, Country_LI_ChDesp}, /* Liechtenstein */
	{"LT", CE, FALSE, Country_LT_ChDesp}, /* Lithuania */
	{"LU", CE, FALSE, Country_LU_ChDesp}, /* Luxembourg */
	{"MO", CE, FALSE, Country_MO_ChDesp}, /* Macao */
	{"MK", CE, FALSE, Country_MK_ChDesp}, /* Macedonia, Republic of */
	{"MY", CE, FALSE, Country_MY_ChDesp}, /* Malaysia */
	{"MT", CE, FALSE, Country_MT_ChDesp}, /* Malta */
	{"MX", CE, FALSE, Country_MX_ChDesp}, /* Mexico */
	{"MC", CE, FALSE, Country_MC_ChDesp}, /* Monaco */
	{"MA", CE, FALSE, Country_MA_ChDesp}, /* Morocco */
	{"NP", CE, FALSE, Country_NP_ChDesp}, /* Nepal */
	{"NL", CE, FALSE, Country_NL_ChDesp}, /* Netherlands */
	{"AN", CE, FALSE, Country_AN_ChDesp}, /* Netherlands Antilles */
	{"NZ", CE, FALSE, Country_NZ_ChDesp}, /* New Zealand */
	{"NO", CE, FALSE, Country_NO_ChDesp}, /* Norway */
	{"OM", CE, FALSE, Country_OM_ChDesp}, /* Oman */
	{"PK", CE, FALSE, Country_PK_ChDesp}, /* Pakistan */
	{"PA", CE, FALSE, Country_PA_ChDesp}, /* Panama */
	{"PG", CE, FALSE, Country_PG_ChDesp}, /* Papua New Guinea */
	{"PE", CE, FALSE, Country_PE_ChDesp}, /* Peru */
	{"PH", CE, FALSE, Country_PH_ChDesp}, /* Philippines */
	{"PL", CE, FALSE, Country_PL_ChDesp}, /* Poland */
	{"PT", CE, FALSE, Country_PT_ChDesp}, /* Portuga l*/
	{"PR", CE, FALSE, Country_PR_ChDesp}, /* Puerto Rico */
	{"QA", CE, FALSE, Country_QA_ChDesp}, /* Qatar */
	{"RO", CE, FALSE, Country_RO_ChDesp}, /* Romania */
	{"RU", CE, FALSE, Country_RU_ChDesp}, /* Russian Federation */
	{"BL", CE, FALSE, Country_BL_ChDesp}, /* Saint Barth'elemy */
	{"SA", CE, FALSE, Country_SA_ChDesp}, /* Saudi Arabia */
	{"SG", CE, FALSE, Country_SG_ChDesp}, /* Singapore */
	{"SK", CE, FALSE, Country_SK_ChDesp}, /* Slovakia */
	{"SI", CE, FALSE, Country_SI_ChDesp}, /* Slovenia */
	{"ZA", CE, FALSE, Country_ZA_ChDesp}, /* South Africa */
	{"ES", CE, FALSE, Country_ES_ChDesp}, /* Spain */
	{"LK", CE, FALSE, Country_LK_ChDesp}, /* Sri Lanka */
	{"SE", CE, FALSE, Country_SE_ChDesp}, /* Sweden */
	{"CH", CE, FALSE, Country_CH_ChDesp}, /* Switzerland */
	{"SY", CE, FALSE, Country_SY_ChDesp}, /* Syrian Arab Republic */
	{"TW", FCC, FALSE, Country_TW_ChDesp}, /* Taiwan */
	{"TH", CE, FALSE, Country_TH_ChDesp}, /* Thailand */
	{"TT", CE, FALSE, Country_TT_ChDesp}, /* Trinidad and Tobago */
	{"TN", CE, FALSE, Country_TN_ChDesp}, /* Tunisia */
	{"TR", CE, FALSE, Country_TR_ChDesp}, /* Turkey */
	{"UA", CE, FALSE, Country_UA_ChDesp}, /* Ukraine */
	{"AE", CE, FALSE, Country_AE_ChDesp}, /* United Arab Emirates */
	{"GB", CE, FALSE, Country_GB_ChDesp}, /* United Kingdom */
	{"US", FCC, FALSE, Country_US_ChDesp}, /* United States */
	{"UY", CE, FALSE, Country_UY_ChDesp}, /* Uruguay */
	{"UZ", CE, FALSE, Country_UZ_ChDesp}, /* Uzbekistan */
	{"VE", CE, FALSE, Country_VE_ChDesp}, /* Venezuela */
	{"VN", CE, FALSE, Country_VN_ChDesp}, /* Viet Nam */
	{"YE", CE, FALSE, Country_YE_ChDesp}, /* Yemen */
	{"ZW", CE, FALSE, Country_ZW_ChDesp}, /* Zimbabwe */
	{"EU", CE, FALSE, Country_EU_ChDesp}, /* Europe */
